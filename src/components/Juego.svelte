  ...
  <div class="flex flex-col items-center justify-center gap-3 pl-[3vw]">
    {#if gameOver}
      <div class="text-center flex flex-col gap-3">
        ...
        <button
          onclick={replay}
          class="mt-2 px-5 py-2 bg-green-600 hover:bg-green-500 text-white font-bold text-sm uppercase tracking-wider rounded-sm transition-colors cursor-pointer"
        >
          🔄 Jugar de nuevo
        </button>
        <button
          onclick={onRestart}
          class="px-4 py-1.5 bg-gray-700 hover:bg-gray-600 text-gray-300 hover:text-white text-xs font-semibold uppercase tracking-wider rounded-sm transition-all cursor-pointer border border-gray-600 hover:border-gray-400"
        >
          🏠 Inicio
        </button>
      </div>
